    ...
    <main>
        <!-- Hero Section -->
        <section id="inicio" class="section white-text" style="     background: linear-gradient(180deg, rgba(0, 0, 0, 0.5) 0%, rgba(33, 149, 243, 0.26) 100%), 
                        url('vistas/plantillas/images/IMMUFA.jpg');
                ...
                <div class="row">
                        ...
                        <div class="card hoverable">
                            <div class="card-content">
                                <span class="card-title blue-text text-darken-2">
                                    <i class="fas fa-flag left"></i>Misión
                                </span>
                    ...
                    <div class="col s12 m6">
                        <div class="card hoverable">
                            <div class="card-content">
                                <span class="card-title blue-text text-darken-2">
                                    <i class="fas fa-eye left"></i>Visión
                                </span>
