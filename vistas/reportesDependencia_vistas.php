...
<div class="card">
  ...
  <div class="card-body">
    ...
    <h4 class="card-title">Cantidad de Pacientes por Dependecias</h4>
            ...
            <table  class="table table-hover table-responsive" cellspacing="0" width="100%" role="grid" aria-describedby="example23_info" style="width: 100%;" id="tablaCita">
              ...
              <thead>
                ...
                <tr role="row">
                  ...
                  <th class=""  rowspan="1" colspan="1">Dependecias</th>
              ...
              <tbody>
                ...
                <?php /// aqui va la cabezera 
                                                    ...
                                                    echo $in_mini_paciente->listar_citas_cantidad_dependecias_tabla_controlador();
...
<div class="card">
                    ...
                    <div class="col-md-12">
                    <h2 class="text-center mb-4">Citas por Dependecias</h2>
                                <div class="card">
                                    <div class="card-body">
                                        <div class="chart-container">
                                            <canvas id="donutChartdependecias"></canvas>
